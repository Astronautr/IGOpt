...
public class GradientEvaluator extends AbstractExpressionVisitor {
    ...
    private final Gradient[] values;
    private final SetIntervalContext ic;

    GradientEvaluator(SetIntervalContext ic, CodeList list, Expression... results) {
        this.list = list;
        this.results = results.clone();
        values = new Gradient[list.getNumExprs()];
        this.ic = ic;
    }

    public Gradient[] evaluate(Gradient[] args) {
        ...
        Gradient[] retVal = new Gradient[results.length];
