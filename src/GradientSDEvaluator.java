...
public class GradientSDEvaluator extends AbstractExpressionVisitor {
    final CodeList list;
    final Expression[] results;
    private final GradientSD[] values;
    private final SetIntervalContext ic;

    GradientSDEvaluator(SetIntervalContext ic, CodeList list, Expression... results) {
        this.list = list;
        this.results = results.clone();
        values = new GradientSD[list.getNumExprs()];
        this.ic = ic;
    }

    public GradientSD[] evaluate(GradientSD[] args) {
        ...
        GradientSD[] retVal = new GradientSD[results.length];
    ...
    public void visitLit(int r, String numerator, String denominator) {
        ...
        values[r] = GradientSD.nums(v.inf(), v.sup());
    }
